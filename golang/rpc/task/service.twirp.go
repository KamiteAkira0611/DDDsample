...
func (c *aPIProtobufClient) ListTask(ctx context.Context, in *ListTaskReq) (*ListTaskResp, error) {
...
func (c *aPIJSONClient) ListTask(ctx context.Context, in *ListTaskReq) (*ListTaskResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.task")
	ctx = ctxsetters.WithServiceName(ctx, "API")
	ctx = ctxsetters.WithMethodName(ctx, "ListTask")
	out := new(ListTaskResp)
...
const APIPathPrefix = "/twirp/twirp.task.API/"
...
func (s *aPIServer) serveListTask(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	case "application/json":
		s.serveListTaskJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveListTaskProtobuf(ctx, resp, req)
	default:
...
func (s *aPIServer) serveListTaskJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "ListTask")
	...
	func() {
		...
		respContent, err = s.API.ListTask(ctx, reqContent)
	}()
...
func (s *aPIServer) serveListTaskProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "ListTask")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
var twirpFileDescriptor0 = []byte{
	...
	0x84, 0x24, 0x16, 0x67, 0x0b, 0xf1, 0x71, 0x31, 0x65, 0xa6, 0x48, 0x30, 0x2a, 0x30, 0x6a, 0x30,
	0x07, 0x31, 0x65, 0xa6, 0x08, 0x09, 0x71, 0xb1, 0x24, 0xe5, 0xa7, 0x54, 0x4a, 0x30, 0x29, 0x30,
	0x6a, 0x70, 0x06, 0x81, 0xd9, 0x4a, 0xbc, 0x5c, 0xdc, 0x3e, 0x99, 0xc5, 0x25, 0x20, 0xf5, 0x41,
	0xa9, 0x85, 0x4a, 0x66, 0x5c, 0x3c, 0x08, 0x6e, 0x71, 0x81, 0x90, 0x1a, 0x17, 0x2b, 0xc8, 0xc8,
